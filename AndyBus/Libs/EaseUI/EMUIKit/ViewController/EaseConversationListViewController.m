...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (model.conversation.lastReceivedMessage) {
        //如果有别人发的消息  就是说最后一条是别人发的  那就显示好友发来的他自己的信息
        cell.nick_name = model.conversation.lastReceivedMessage.ext[@"self_nick_name"];
        cell.head_image = model.conversation.lastReceivedMessage.ext[@"self_head_image"];
    }else{
        //如果没有收到好友发消息  就是说只要自己发的消息  那就显示我发的消息里边好友的信息
        cell.nick_name = model.conversation.latestMessage.ext[@"other_nick_name"];
        cell.head_image = model.conversation.latestMessage.ext[@"other_head_image"];
    }
    ...
    cell.titleLabel.text = cell.nick_name;
    
    [cell.avatarView.imageView sd_setImageWithURL:[NSURL URLWithString:cell.head_image] placeholderImage:[UIImage imageNamed:@""]];
