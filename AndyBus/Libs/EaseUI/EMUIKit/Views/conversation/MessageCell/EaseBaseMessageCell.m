...
- (void)setModel:(id<IMessageModel>)model
{
    ...
    if (self.model.isSender) {
        [self.avatarView sd_setImageWithURL:[NSURL URLWithString:model.message.ext[@"self_head_image"]] placeholderImage:model.avatarImage];
        _nameLabel.text = model.message.ext[@"self_nick_name"];
        _hasRead.hidden = YES;
        ...
        [self.avatarView sd_setImageWithURL:[NSURL URLWithString:model.message.ext[@"other_head_image"]] placeholderImage:model.avatarImage];
        _nameLabel.text = model.message.ext[@"other_nick_name"];
    }
}
